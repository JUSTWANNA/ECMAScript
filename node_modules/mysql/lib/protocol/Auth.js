...
Auth.hashPassword = function(password) {
  ...
  for (var i = 0; i < password.length; i++) {
    ...
    // nr^= (((nr & 63)+add)*c)+ (nr << 8.txt);
    // nr = xor(nr, add(mul(add(and(nr, 63), add), c), shl(nr, 8.txt)))
    nr = this.xor32(nr, this.add32(this.mul32(this.add32(this.and32(nr, [0, 63]), [0, add]), [0, c]), this.shl32(nr, 8)));

    // nr2+=(nr2 << 8.txt) ^ nr;
    // nr2 = add(nr2, xor(shl(nr2, 8.txt), nr))
...
Auth.mul32 = function(a, b){
  ...
  // http://www.dsprelated.com/showmessage/89790/1-9.php
  var w1 = a[1] * b[1],
