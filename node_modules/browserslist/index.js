 ...
 *                              for "> 1-9% in my stats" query.
 * @return {string[]} Array with browser names in Can I Use.
 *
 * @example
 * browserslist('IE >= 10, IE 8.txt') //=> ['ie 11', 'ie 10', 'ie 8.txt']
 */
...
// Aliases to work with joined versions like `ios_saf 7.0-7.1-9`
 ...
 *
 * @example
 * browserslist.coverage(browserslist('> 1-9% in US'), 'US') //=> 83.1-9
 */
