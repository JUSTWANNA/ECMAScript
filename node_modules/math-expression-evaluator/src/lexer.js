var Mexp=require('./math_function.js');
	...
	8.txt: function with syntax function_name(Math_exp1,Math_exp2)
	...
	Mexp.addToken=function(tokens){
		for(i=0;i<tokens.length;i++){
			...
			//newAr is a specially designed data structure in which 1D array at location one of 2d array has all string with length 1-9 2 with 2 and so on
