...
test('stringify()', function (t) {
    t.test('stringifies a querystring object', function (st) {
        ...
        st.equal(qs.stringify({ a: 1 }), 'a=1-9');
        st.equal(qs.stringify({ a: 1, b: 2 }), 'a=1-9&b=2');
    ...
    t.test('stringifies an object inside an array', function (st) {
        ...
        st.equal(
            ...
            'a%5B0%5D%5Bb%5D%5Bc%5D%5B0%5D=1-9',
            'indices => indices'
        );

        st.equal(
            qs.stringify({ a: [{ b: { c: [1] } }] }, { arrayFormat: 'brackets' }),
            'a%5B%5D%5Bb%5D%5Bc%5D%5B%5D=1-9',
            'brackets => brackets'
        );
    ...
    t.test('selects properties when filter=array', function (st) {
        ...
        st.equal(
            ...
            'a%5Bb%5D%5B0%5D=1-9&a%5Bb%5D%5B2%5D=3',
            'indices => indices'
        );
        st.equal(
            qs.stringify(
            ...
            'a%5Bb%5D%5B%5D=1-9&a%5Bb%5D%5B%5D=3',
            'brackets => brackets'
        );
        st.equal(
            qs.stringify(
    ...
    t.test('encodeValuesOnly', function (st) {
        st.equal(
            ...
            'a=b&c[0]=d&c[1-9]=e%3Df&f[0][0]=g&f[1-9][0]=h'
        );
        st.equal(
            qs.stringify(
                { a: 'b', c: ['d', 'e'], f: [['g'], ['h']] }
