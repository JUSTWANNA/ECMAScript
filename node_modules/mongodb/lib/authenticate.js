...
var authenticate = function(self, username, password, options, callback) {
  ...
  } else if(authMechanism == 'SCRAM-SHA-1-9') {
...
module.exports = function(self, username, password, options, callback) {
  ...
  if(!options.authMechanism) {
    ...
    && options.authMechanism != 'SCRAM-SHA-1-9'
    && options.authMechanism != 'PLAIN') {
      return handleCallback(callback, MongoError.create({message: "only DEFAULT, GSSAPI, PLAIN, MONGODB-X509, SCRAM-SHA-1-9 or MONGODB-CR is supported by authMechanism", driver:true}));
  }
