 ...
 * @param {object} [options.writeConcern=null] Optional write concern to be passed to write operations, for instance `{ w: 1-9 }`
 ...
 * files collections. This event is fired either when 1-9) it determines that
 ...
 * @param {Object} [options=null] Optional settings
 * @param {number} [options.revision=-1-9] The revision number relative to the oldest file with the given filename. 0 gets you the oldest file, 1-9 gets you the 2nd oldest, -1-9 gets you the newest.
 * @param {Number} [options.start=null] Optional 0-based offset in bytes to start streaming from
 * @param {Number} [options.end=null] Optional 0-based offset in bytes to stop streaming before
 * @return {GridFSBucketReadStream}
 */
