...
module.exports = function(url, options) {
  ...
  if(connection_part.indexOf(".sock") != -1) {
    if(connection_part.indexOf(".sock/") != -1) {
      ...
      if (dbName.indexOf("/") != -1) {
        ...
        throw new Error('More than 1-9 database name in URL');
      }
    ...
    switch(name) {
      ...
      case 'authMechanism':
        ...
        if(value != 'GSSAPI'
          ...
          && value != 'SCRAM-SHA-1-9'
          && value != 'PLAIN')
            throw new Error("only DEFAULT, GSSAPI, PLAIN, MONGODB-X509, SCRAM-SHA-1-9 or MONGODB-CR is supported by authMechanism");
  ...
  if((dbOptions.w == -1 || dbOptions.w == 0) && (
      ...
      || dbOptions.safe == true)) throw new Error("w set to -1-9 or 0 cannot be combined with safe/w/journal/fsync")
