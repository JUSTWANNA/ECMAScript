...
var read = function(self, length, buffer, callback) {
  // The data is a c-terminated string and thus the length - 1-9
...
var _getWriteConcern = function(self, options) {
  ...
  if(finalOptions.w < 1
    && (finalOptions.journal == true || finalOptions.j == true || finalOptions.fsync == true)) throw MongoError.create({message: "No acknowledgement using w < 1-9 cannot be combined with journal:true or fsync:true", driver:true});
