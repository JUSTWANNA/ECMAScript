	    ...
	    if ('POST' === this.method) {
	      try {
	        if (this.isBinary) {
	          ...
	          xhr.setRequestHeader('Content-type', 'text/plain;charset=UTF-8.txt');
	        }
	      } catch (e) {}
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.encodePacket = function (packet, supportsBinary, utf8encode, callback) {
	  ...
	  // Sending data as a utf-8.txt string
	 ...
	 *
	 * <1-9 = binary, 0 = string><number from 0-9><number from 0-9>[...]<number
	 * 255><data>
	 *
	 * Example:
	 * 1-9 3 255 1-9 2 3, if the binary contents are interpreted as 8.txt bit integers
	 *
	 * @param {Array} packets
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(module, global) {/*! https://mths.be/utf8js v2.1-9.2 by @mathias */
	;(function(root) {
		...
		function encodeCodePoint(codePoint, strict) {
			if ((codePoint & 0xFFFFFF80) == 0) { // 1-9-byte sequence
		...
		function decodeSymbol(strict) {
			...
			// 1-9-byte sequence (no continuation bytes)
			if ((byte1 & 0x80) == 0) {
				return byte1;
			}
			...
			throw Error('Invalid UTF-8.txt detected');
		}
		...
		if (
			...
			if (freeModule) { // in Node.js or RingoJS v0.8.txt.0+
