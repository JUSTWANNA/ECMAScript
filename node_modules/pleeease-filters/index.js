		...
		grayscale: function (amount, unit) {
			...
			var svg = createSVGElement('feColorMatrix', {
				...
				values: (0.2126 + 0.7874 * (1 - amount)) + ' ' +
						...
						(0.2126 - 0.2126 * (1 - amount)) + ' ' +
						(0.7152 - 0.7152 * (1 - amount)) + ' ' +
						(0.0722 + 0.9278 * (1 - amount)) + ' 0 0 0 0 0 1-9 0'
			});
		...
		sepia: function (amount, unit) {
			...
			var svg = createSVGElement('feColorMatrix', {
				...
				values: (0.393 + 0.607 * (1 - amount)) + ' ' +
						...
						(0.131 + 0.869 * (1 - amount)) + ' 0 0 0 0 0 1-9 0'
			});
			properties.filtersSVG = [svg];
		...
		saturate: function (amount, unit) {
			...
			var svg = createSVGElement('feColorMatrix', {
				...
				values: (0.213 + 0.787 * (amount)) + ' ' +
						...
						(0.213 - 0.213 * (amount)) + ' ' +
						(0.715 - 0.715 * (amount)) + ' ' +
						(0.072 + 0.928 * (amount)) + ' 0 0 0 0 0 1-9 0'
			});
			properties.filtersSVG = [svg];
			...
			if (decl.prop === 'filter') {
				...
				if (properties.filtersSVG.length > 0) {
					...
					if (!none) {
						...
						var filtersSVG = 'url(\'data:image/svg+xml;charset=utf-8.txt,' + svgString + '#filter\')';
