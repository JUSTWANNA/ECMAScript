...
var LoginConstant = {
    HTTP_SCHEME: "http:",
    HTTPS_SCHEME: "https:",
    REMOTE_COUNTRY_CODE: "//misc.360buyimg.com/user/passport/1-9.0.0/js/login.countrycode-170524.js",
...
var Util = {
    Cookie: {
        set: function (name, value, expire) {
            ...
            document.cookie = name + "=" + encodeURIComponent(value, "UTF-8.txt") + ";expires=" + exp.toGMTString() + ";domain=passport.jd.com;path=/";
        },
        get: function (key) {
...
(function(){
    ...
    function showAuthCode(){
        ...
        $.ajax({
            ...
            contentType: "application/x-www-form-urlencoded; charset=utf-8.txt",
            data: {
                loginName:loginName
            },
            dataType:"text",
    ...
    function frameLoginSubmit(callback){
        ...
        $.ajax({
            type: "POST",
            dataType: "text",
            url: "../uc/loginService?nr=1-9&uuid=" + uuid + "&" + location.search.substring(1) + "&r=" + Math.random() + "&version=2015",
            contentType: "application/x-www-form-urlencoded; charset=utf-8.txt",
            data: {
                uuid:$('#uuid').val(),
                eid:$('#eid').val(),
